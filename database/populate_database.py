...
from utils.utils import get_next_trading_dt, get_last_trading_dt, daterange_in_db, get_date_time
...
def populate_database(
    ...
    path_to_lobster_data: str = os.path.abspath(__file__).replace('\simulation\OrderbookSimulator.py',"\data"),
...
parser.add_argument("-nl", "--n_levels", action="store", type=int, default=5, help="the number of orderbook levels")
parser.add_argument(
